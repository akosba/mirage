...
// added by @akosba
// The following methods do not assume the addition of the input consistency constraints  (input_i * 0 = 0)
// These methods are used in Mirage as we build our protocol on Groth16, which does not require adding these constraints (in contrast to [BCTV14])
template<typename FieldT>
